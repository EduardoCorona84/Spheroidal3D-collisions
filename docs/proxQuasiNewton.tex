...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{randProblems_noStructure_n_100_150_boxPlot.pdf}
    \caption{\protect \input{fig/randProblems_noStructure_n_100_150_caption.tex}}
    \label{fig:ammphi-med}
\end{figure} 

\begin{table}[ht]
    \resizebox{\textwidth}{!}{
    \input{fig/randProblems_noStructure_n_100_150_table.tex}
    }
    \caption{Table for $n\in[150, 200]$}
\end{table}
\pagebreak
