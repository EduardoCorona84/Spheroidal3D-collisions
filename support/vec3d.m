classdef vec3d
    ...
    methods
        ...
        function obj = vec3d(varargin)
            %-- The constructor for the vec3d class. With no argument it makes the
            %fields empty. With one input, if the class of the input is vec3d, it makes
        ...
        function obj = movePole(obj, varargin)
            cart = movePole(reshape(obj.to_array,[],3), varargin{:});
            obj.x = cart(:,1);
            obj.y = cart(:,2);
            obj.z = cart(:,3);
