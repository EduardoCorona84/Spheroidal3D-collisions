...
if( ntarget == 0 ) 
mex_id_ = 'lfmm3dpartself(c io int[x], c i int[x], c i int[x], c i double[xx], c i int[x], c i dcomplex[], c i int[x], c i dcomplex[], c i double[xx], c i int[x], c io dcomplex[], c i int[x], c io dcomplex[])';
...
mex_id_ = 'lfmm3dparttarg(c io int[x], c i int[x], c i int[x], c i double[xx], c i int[x], c i dcomplex[], c i int[x], c i dcomplex[], c i double[xx], c i int[x], c io dcomplex[], c i int[x], c io dcomplex[], c i int[x], c i double[], c i int[x], c io dcomplex[], c i int[x], c io dcomplex[])';
