function [x, info] = alternatingHighAndLowProxQuasiNewton(fg, x0, opts)
    % Add some opts/for inner/outer/similar.
    ...
    while true
        ...
        step_k = @(t, opts) alternatingFwdBwdstep(t, x_km1, Ax_km1, q, prox_k, fg, opts);
        % Linesearch 
        opts.k = k;
