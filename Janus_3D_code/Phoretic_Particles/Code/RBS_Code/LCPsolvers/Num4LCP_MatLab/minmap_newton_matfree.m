function [x,err,iter,flag,convergence,msg] = minmap_newton_matfree( A, b, x0, max_iter, tol_rel, tol_abs, profile )
...
while (iter <= max_iter )
  ...
  [dx ,~ ] = gmres( J, (-phi), restart,[],[],[],[],dx0);   % Use shur method -- its more efficient, I'm lazy here
