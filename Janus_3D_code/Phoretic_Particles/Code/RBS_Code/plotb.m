...
for ii=1:nv
    ...
    if ( nargin>1 && ~isempty(C) )
        ...
        % h(ii) = surf([x x(:,1)], [y y(:,1)], [z z(:,1)],[1 1 1], varargin{:});
    ...
    if (nargin == 1 || isempty(C))
        set(h,'FaceColor',[128 128 128]./255./3,'EdgeColor','none','BackFaceLighting','lit',...
            'AmbientStrength',.3,'DiffuseStrength',.8,...
            'SpecularStrength',.9,'SpecularExponent',25);
        % set(h,'FaceColor',[128 128 128]./255,'EdgeColor','none','BackFaceLighting','lit');
