function [x1, x2, distances, neighbors] = allWithWallSigned(par, planeNormal, planePoint, eta)
    n = length(par); 
    ...
    for i=1:n
        [x1New, x2New, d] = planeEllipsoidIntersectionSigned(par(i), planeNormal, planePoint);
        distances(i) = d;
