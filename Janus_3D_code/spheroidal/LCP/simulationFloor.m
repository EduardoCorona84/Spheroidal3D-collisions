function configurations = simulationFloor(initialConfiguration, totalSteps, timeStart, timeEnd, initialVelocity, density, dragType)
    ...
    for i = 2:totalSteps + 1
        ...
        [x1Wall, x2Wall, distancesWall, neighborsWall] = allWithWall(configuration, planeNormal, planePoint, eta);
