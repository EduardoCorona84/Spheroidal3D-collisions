function [Kernels,Nullsp,Fparams,timings] = MS_update_operators(Xt,Ct,Mt,nrmW,Kernels,Fparams,timings,i)
    %{
        ...
        TODO: Every line with RBS code needs to be updated to use the L2Stk code.

        %%%%%%%%%%%%%%%%
        CODE ANNOTATIONS
        %%%%%%%%%%%%%%%%
        TSL -> Traction (of the) single layer (traction layer potential)
        SL -> Single layer potential
        DSL -> Double layer potential
    %}
    ...
    % The 'TSL_Stk_3D' flag seems to be a placeholder.
    ...
    % Here, Lk is the actual nullspace operator.
