...
#SBATCH --output=/projects/niru8088/Spheroidal3D-collisions/Janus_3D_code/LCPsolvers/data/$PREFIX/ix_%a.p_4.tol_1e-6.out
#SBATCH --error=/projects/niru8088/Spheroidal3D-collisions/Janus_3D_code/LCPsolvers/data/$PREFIX/ix_%a.p_4.tol_1e-6.err
