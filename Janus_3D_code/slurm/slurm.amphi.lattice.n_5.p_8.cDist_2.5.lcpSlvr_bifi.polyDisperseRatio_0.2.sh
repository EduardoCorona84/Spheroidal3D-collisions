...
#SBATCH --qos=mem
#SBATCH --job-name=amphi.lattice.n_5.bifi.poly
#SBATCH --output=/projects/niru8088/Spheroidal3D-collisions/Janus_3D_code/resultsForRecord/amphi.lattice.n_5.bifi.poly.out
#SBATCH --error=/projects/niru8088/Spheroidal3D-collisions/Janus_3D_code/resultsForRecord/amphi.lattice.n_5.bifi.poly.err 
