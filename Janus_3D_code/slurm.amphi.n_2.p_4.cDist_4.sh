...
#SBATCH --job-name=amphi.n_2.p_4.cDist_4%j
#SBATCH --output=/projects/niru8088/Spheroidal3D-collisions/Janus_3D_code/results/amphi.n_2.p_4.cDist_4.%j.out
#SBATCH --error=/projects/niru8088/Spheroidal3D-collisions/Janus_3D_code/results/amphi.n_2.p_4.cDist_4.%j.err 
...
p=4; # number of spherical harmonics
Cdst=4; # initial distance of the particle centers
