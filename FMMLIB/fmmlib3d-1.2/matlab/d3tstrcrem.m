...
mex_id_ = 'd3tstrcrem(c io int[x], c i double[], c i int[x], c io int[x], c io int[x], c io int[], c io int[], c io int[x], c io double[], c io double[], c i double[], c i int[x], c io int[], c io double[], c i int[x], c io int[x], c i int[x], c i int[x], c i int[x])';
